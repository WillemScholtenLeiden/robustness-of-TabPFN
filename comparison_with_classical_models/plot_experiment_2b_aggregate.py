"""
Aggregate plotting functions for Experiment 2b.

Usage:
    data = load_experiment_data("comparison_with_classical_models")
    plot_experiment_2b_aggregate(data, save_dir="figures")
"""
...
def plot_experiment_2b_aggregate(data: dict[str, Any], save_dir: str = "figures"):
    """Create and save the aggregate 2x2 panel figure for Experiment 2b."""
    _apply_style()
    ...
    fig.savefig(os.path.join(save_dir, "exp2b_aggregate.pdf"))
    plt.close(fig)

    print(f"Experiment 2b aggregate figure saved to '{save_dir}/exp2b_aggregate.pdf'.")


if __name__ == '__main__':
    data = load_experiment_data("comparison_with_classical_models")
    plot_experiment_2b_aggregate(data)
