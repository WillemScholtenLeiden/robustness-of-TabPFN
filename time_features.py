...
dataset_loaders.append((create_synthetic_dataset, {'features': 2, **data_args}))

for i in range(1, 6):
    dataset_loaders.append((create_synthetic_dataset, {'features': i*10, **data_args}))
...
exp.print_results()
exp.save_results('results/feature_timing.pkl')